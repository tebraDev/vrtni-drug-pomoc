...
export const translations: Record<Locale, Dict> = {
  "sr-Latn": {
    ...
    hero: {
      ...
      serviceArea: "Radimo u Rasinskom okrugu: Trstenik · Kruševac · Vrnjačka Banja · Aleksandrovac",
  ...
  "sr-Cyrl": {
    ...
    hero: {
      ...
      serviceArea: "Радимо у Расинском округу: Трстеник · Крушевац · Врњачка Бања · Александровац",
  ...
  de: {
    ...
    hero: {
      ...
      serviceArea: "Einsatzgebiet Region Rasina: Trstenik · Kruševac · Vrnjačka Banja · Aleksandrovac",
  ...
  en: {
    ...
    hero: {
      ...
      serviceArea: "Serving the Rasina region: Trstenik · Kruševac · Vrnjačka Banja · Aleksandrovac",
    ...
    send: {
      ...
      successIntro: "Your message was sent successfully. We'll be in touch soon.",
      whatNextTitle: "What happens next?",
      whatNextSteps: [
        "We review your request (usually within a few hours).",
        "We contact you by phone or WhatsApp to confirm the appointment.",
        "We send the final quote and schedule the first visit.",
      ],
      contactNowTitle: "Need us right away?",
      contactNowDesc: "Message us on WhatsApp or call directly — we reply faster.",
      waBtn: "WhatsApp",
      callBtn: "Call",
      newOrder: "New order",
      phoneInvalid: "Please enter a valid number (e.g. +381 60 123 4567).",
    },
    meta: {
